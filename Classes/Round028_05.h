...
#ifndef __AbelLLExplorer__Round028_05__
#define __AbelLLExplorer__Round028_05__

#include "RoundBase.h"

USING_NS_CC;
class Actor;
class Round028_05 : public RoundBase
{
public:
    Round028_05();
    virtual ~Round028_05();
...
public:
    ...
    static Round028_05* createWithRoundIndex(const int, StageScene*, const Vec2& pos = Vec2::ZERO);
...
#endif /* defined(__AbelLLExplorer__Round028_05__) */
